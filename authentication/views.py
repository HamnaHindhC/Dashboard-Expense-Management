...
class RegistrationView(View):
 ...
 # messages.success(request,'Success Whatsapp Success')
        ...
        # messages.info(request,'Success Whatsapp inform')
    ...
    def get(self,request,uidb64,token):
        try:
              ...
              if not account_activation_token.check_token(user, token):
                    return redirect('login' + '?message=' + 'User already activated or invalid token')
...
class RequestPasswordResetEmail(View):
    ...
    def post(self, request):
        ...
        if user.exists():
            ...
            link = reverse('user-reset-password', kwargs={
            ...
            email = EmailMessage(
                        email_subject,
                        'Hi there, Please click link below to reset your password \n'+ reset_url,
                        'noreply@semycolon.com',
                        [email],
                    )
            EmailThread(email).start()
